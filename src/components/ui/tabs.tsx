...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-end justify-center rounded-lg bg-muted p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
...
const TabsTriggerInvisible = React.forwardRef<
...
TabsTriggerInvisible.displayName = TabsPrimitive.Trigger.displayName;
...
export { Tabs, TabsList, TabsTrigger, TabsTriggerInvisible, TabsContent };
